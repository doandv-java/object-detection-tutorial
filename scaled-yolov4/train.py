...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/configs/coco.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/configs/hyp.finetune.yaml', help='hyperparameters path, i.e. data/hyp.scratch.yaml')
